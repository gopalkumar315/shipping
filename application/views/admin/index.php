...
<head>
    ...
    <link href="<?php echo base_url();?>admin/css/plugins.css" rel="stylesheet">
    <link href="<?php echo base_url();?>admin/css/style.min.css" rel="stylesheet">
    <link href="#" rel="stylesheet" id="theme-color">
    <!-- END  MANDATORY STYLE -->
    <!-- BEGIN PAGE LEVEL STYLE -->
    <link href="<?php echo base_url();?>admin/plugins/fullcalendar/fullcalendar.css" rel="stylesheet">
    <link href="<?php echo base_url();?>admin/plugins/metrojs/metrojs.css" rel="stylesheet">
...
<body data-page="dashboard">
                    ...
                    <li class="dropdown" id="user-header">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown-footer clearfix">
                                ...
                                <a href="<?php echo base_url('index.php/admin/panel/logout'); ?>" title="Logout">
                            ...
                            <div class="chat-popup-inner bg-blue">
                                <div>
                                    <div class="clearfix w-600">
                                        <img src="<?php echo base_url();?>admin/img/avatars/avatar3.png" alt="avatar 3" width="30" class="pull-left img-circle p-r-5">Alexa Johnson</div>
        ...
        <nav id="sidebar">
            ...
            <div class="footer-widget">
                ...
                <div class="sidebar-footer clearfix">
                    ...
                    <a class="pull-left" href="<?php echo base_url('index.php/admin/panel/logout'); ?>" data-rel="tooltip" data-placement="top" data-original-title="Logout"><i class="fa fa-power-off"></i></a>
                </div>
            </div>
        </nav>
        <!-- END MAIN SIDEBAR -->
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="withScroll" data-height="320">
                                        <a href="#" class="message-item media">
                                            <div class="media">
                                                <img src="<?php echo base_url();?>admin/img/avatars/avatar1.png" alt="avatar 1" width="35" class="pull-left">
                                        ...
                                        <a href="#" class="message-item media">
                                            <div class="media">
                                                <img src="<?php echo base_url();?>admin/img/avatars/avatar2.png" alt="avatar 2" width="35" class="pull-left">
                                                <div class="media-body">
                                                    <div class="pull-left">
                                        ...
                                        <a href="#" class="message-item media">
                                            <div class="media">
                                                <img src="<?php echo base_url();?>admin/img/avatars/avatar3.png" alt="avatar 3" width="35" class="pull-left">
                                                <div class="media-body">
                                                    <div class="pull-left">
                                                        <p class="c-dark m-0"><strong>John Snow</strong>
                                                        </p>
                                        ...
                                        <a href="#" class="message-item media">
                                            <div class="media">
                                                <img src="<?php echo base_url();?>admin/img/avatars/avatar4.png" alt="avatar 4" width="35" class="pull-left">
                                                <div class="media-body">
                                                    <div class="pull-left">
                                                        <p class="c-dark m-0"><strong>Jerry Smith</strong>
                                                        </p>
                                        ...
                                        <a href="#" class="message-item media">
                                            <div class="media">
                                                <img src="<?php echo base_url();?>admin/img/avatars/avatar5.png" alt="avatar 5" width="35" class="pull-left">
                                                <div class="media-body">
                                                    <div class="pull-left">
                                                        <p class="c-dark m-0"><strong>John Snow</strong>
                                                        </p>
                                        ...
                                        <a href="#" class="message-item media">
                                            <div class="media">
                                                <img src="<?php echo base_url();?>admin/img/avatars/avatar6.png" alt="avatar 6" width="35" class="pull-left">
                                                <div class="media-body">
                                                    <div class="pull-left">
                                                        <p class="c-dark m-0"><strong>Jerry Smith</strong>
                                                        </p>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="withScroll" data-height="480">
                                        <a href="#" class="message-item media">
                                            <div class="media">
                                                <img src="<?php echo base_url();?>admin/img/avatars/avatar13_big.png" alt="avatar 13" width="50" class="pull-left">
                                                <div class="media-body">
                                        ...
                                        <a href="#" class="message-item media">
                                            <div class="media">
                                                <img src="<?php echo base_url();?>admin/img/avatars/avatar12_big.png" alt="avatar 12" width="50" class="pull-left">
                                                <div class="media-body">
                                                    <small class="pull-right">23 Sept</small>
                                        ...
                                        <a href="#" class="message-item media">
                                            <div class="media">
                                                <img src="<?php echo base_url();?>admin/img/avatars/avatar11_big.png" alt="avatar 11" width="50" class="pull-left">
                                                <div class="media-body">
                                                    <small class="pull-right">23 Sept</small>
                                                    <h5 class="c-dark"><strong>John Snow</strong></h5>
                                                    <h4 class="c-dark">Reset your account password</h4>
                                        ...
                                        <a href="#" class="message-item media">
                                            <div class="media">
                                                <img src="<?php echo base_url();?>admin/img/avatars/avatar10_big.png" alt="avatar 10" width="50" class="pull-left">
                                                <div class="media-body">
                                                    <small class="pull-right">23 Sept</small>
                                                    <h5 class="c-dark"><strong>Jerry Smith</strong></h5>
                                                    <h4 class="c-dark">Check Dropbox</h4>
                                        ...
                                        <a href="#" class="message-item media">
                                            <div class="media">
                                                <img src="<?php echo base_url();?>admin/img/avatars/avatar9_big.png" alt="avatar 9" width="50" class="pull-left">
                                                <div class="media-body">
                                                    <small class="pull-right">23 Sept</small>
                                                    <h5 class="c-dark"><strong>John Snow</strong></h5>
                                                    <h4 class="c-dark">Reset your account password</h4>
                                        ...
                                        <a href="#" class="message-item media">
                                            <div class="media">
                                                <img src="<?php echo base_url();?>admin/img/avatars/avatar8_big.png" alt="avatar 8" width="50" class="pull-left">
                                                <div class="media-body">
                                                    <small class="pull-right">23 Sept</small>
                                                    <h5 class="c-dark"><strong>Jerry Smith</strong></h5>
                                                    <h4 class="c-dark">Check Dropbox</h4>
                                        ...
                                        <a href="#" class="message-item media">
                                            <div class="media">
                                                <img src="<?php echo base_url();?>admin/img/avatars/avatar7_big.png" alt="avatar 7" width="50" class="pull-left">
                                                <div class="media-body">
                                                    <small class="pull-right">23 Sept</small>
                                                    <h5 class="c-dark"><strong>John Snow</strong></h5>
                                                    <h4 class="c-dark">Reset your account password</h4>
    ...
    <script src="<?php echo base_url();?>admin/plugins/mandatoryJs.min.js"></script>
    <!-- END MANDATORY SCRIPTS -->
    <!-- BEGIN PAGE LEVEL SCRIPTS -->
    <script src="<?php echo base_url();?>admin/plugins/metrojs/metrojs.min.js"></script>
    <script src='<?php echo base_url();?>admin/plugins/fullcalendar/moment.min.js'></script>
    <script src='<?php echo base_url();?>admin/plugins/fullcalendar/fullcalendar.min.js'></script>
    <script src="<?php echo base_url();?>admin/plugins/simple-weather/jquery.simpleWeather.min.js"></script>
    <script src="<?php echo base_url();?>admin/plugins/google-maps/markerclusterer.js"></script>
    <script src="http://maps.google.com/maps/api/js?sensor=true"></script>
    <script src="<?php echo base_url();?>admin/plugins/google-maps/gmaps.js"></script>
    <script src="<?php echo base_url();?>admin/plugins/charts-flot/jquery.flot.js"></script>
    <script src="<?php echo base_url();?>admin/plugins/charts-flot/jquery.flot.animator.min.js"></script>
    <script src="<?php echo base_url();?>admin/plugins/charts-flot/jquery.flot.resize.js"></script>
    <script src="<?php echo base_url();?>admin/plugins/charts-flot/jquery.flot.time.min.js"></script>
    <script src="<?php echo base_url();?>admin/plugins/charts-morris/raphael.min.js"></script>
    <script src="<?php echo base_url();?>admin/plugins/charts-morris/morris.min.js"></script>
    <script src="<?php echo base_url();?>admin/plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js"></script>
    <script src="<?php echo base_url();?>admin/js/calendar.js"></script>
