...
<body data-page="tables_editable" ng-app="MyApp">
                      ...
                      <div  ng-controller="BookStore" class="panel-body">
                          <div class="row">
                              <div class="col-md-12 m-b-20">
                                  <div class="btn-group">
                                      <a href="<?php echo site_url('admin/carrier/add')?>" class="btn btn-danger">Add New</a>
                                  </div>
                              </div>
                              <div  class="col-md-12 col-sm-12 col-xs-12 table-responsive table-red">
                                  ...
                                  <table class="table table-striped table-hover" ts-wrapper>
                                      <thead>
                                          <tr>
                                              <th ts-criteria='id_carrier'>Id</th>
                                              <th ts-criteria="name">Name</th>
                                              <th ts-criteria="url">URL</th>
                                              <th ts-criteria="max_height">Max Height</th>
                                              <th ts-criteria="max_weight">Max Weight</th>                                              
                                              <th ts-criteria="max_depth">Max Depth</th>
                                              <th ts-criteria="max_width">Max width</th>
                                          ...
                                          <td>
                                            ...
                                            <td class="text-center">
                                             <!-- // <span> <button type="submit" class="edit btn btn-dark" ng-hide="editMode" ng-click="editMode = true; editItem(item)" ><i class="fa fa-pencil-square-o"></i> Edit</button></span> -->
                                              <span> <a href="<?php echo site_url('admin/carrier/edit/');?>/{{item.id_carrier}}" class="btn btn-success">Edit</a></span>
                                              <span> <button type="submit" class="edit btn btn-danger"  ng-click="removeItem(item)">Delete</button></span>
  ...
  {  
    ...
    $http.get('<?php echo site_url('admin/carrier/show'); ?>').
   ...
   $scope.addCancel=function(){
    ...
    $scope.removeItem = function(index){
      ...
      if(check==true)
      {
        ...
        var request = $http({
        method: "post",
        url: "<?php echo site_url('admin/carrier/del'); ?>",
        data: {
          'id_carrier':$scope.items[index].id_carrier,
        }
      });
