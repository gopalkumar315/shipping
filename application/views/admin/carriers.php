...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>admin/plugins/datatables/dataTables.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>admin/plugins/datatables/dataTables.tableTools.css">
    <!-- END PAGE LEVEL STYLE -->
    <script src="<?php echo base_url(); ?>admin/plugins/modernizr/modernizr-2.6.2-respond-1.1.0.min.js"></script>
...
<div class="navbar-center">Dynamic Tables</div>
            ...
            <ul class="dropdown-menu-list withScroll" data-height="220">
                <li class="clearfix">
                                        <span class="pull-left p-r-5">
                                            <img src="<?php echo base_url(); ?>admin/img/avatars/avatar3.png"
                                                 alt="avatar 3">
                                        </span>
                ...
                <li class="clearfix">
                                        <span class="pull-left p-r-5">
                                            <img src="<?php echo base_url(); ?>admin/img/avatars/avatar4.png"
                                                 alt="avatar 4">
                                        </span>
                ...
                <li class="clearfix">
                                        <span class="pull-left p-r-5">
                                            <img src="<?php echo base_url(); ?>admin/img/avatars/avatar5.png"
                                                 alt="avatar 5">
                                        </span>
                ...
                <li class="clearfix">
                                        <span class="pull-left p-r-5">
                                            <img src="<?php echo base_url(); ?>admin/img/avatars/avatar6.png"
                                                 alt="avatar 6">
                                        </span>
...
<li class="dropdown" id="user-header">
    <a href="#" class="dropdown-toggle c-white" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
        <img src="<?php echo base_url(); ?>admin/img/avatars/avatar2.png" alt="user avatar" width="30" class="p-r-5">
        ...
        <div class="chat-popup-inner bg-blue">
            <div>
                <div class="clearfix w-600">
                    <img src="<?php echo base_url(); ?>admin/img/avatars/avatar3.png" alt="avatar 3" width="30"
                         class="pull-left img-circle p-r-5">Alexa Johnson
                </div>
...
<li>
    <a href="<?php echo base_url(); ?>/index.php/admin/billing"><i class="glyph-icon flaticon-pages"></i><span
            class="sidebar-text">Billing</span></a>
</li>
<li>
     <a href="<?php echo base_url(); ?>/index.php/admin/carrier_cont" ><i class="glyph-icon flaticon-pages"></i><span
            class="sidebar-text">Carriers</span></a>
</li>
<li>
    <a href="<?php echo base_url(); ?>/index.php/admin/zone_cont" ><i class="glyph-icon flaticon-pages"></i><span
            class="sidebar-text">Zones</span></a>
</li>
<li>
...
<li>
    <a href="#"><i class="glyph-icon flaticon-email"></i><span class="sidebar-text">Email</span><span
...
<li>
    <a href="#"><i class="glyph-icon flaticon-forms"></i><span class="sidebar-text">Forms</span><span
            class="fa arrow"></span></a>
    <ul class="submenu collapse">
        <li>
...
<li>
    <a href="#"><i class="glyph-icon flaticon-ui-elements2"></i><span class="sidebar-text">UI Elements</span><span
            class="fa arrow"></span></a>
    <ul class="submenu collapse">
        <li>
...
<li>
    <a href="#"><i class="glyph-icon flaticon-pages"></i><span class="sidebar-text">Pages</span><span
            class="fa arrow"></span>
    ...
    <ul class="submenu collapse">
        ...
        <li>
            <a href="forum.html"><span class="sidebar-text">Forum<span
                        class="label label-dark pull-right">New</span></span></a>
        </li>
        <li>
            <a href="members.html"><span class="sidebar-text">Members</span></a>
        </li>
        <li>
            <a href="search_results.html"><span class="sidebar-text">Search Results<span
                        class="label label-danger pull-right">New</span></span></a>
        </li>
        <li>
            <a href="contact.html"><span class="sidebar-text">Contact<span
                        class="label label-danger pull-right">New</span></span></a>
        </li>
        <li>
...
<li>
    <a href="#"><i class="glyph-icon flaticon-panels"></i><span class="sidebar-text">Panels</span><span
            class="fa arrow"></span></a>
    <ul class="submenu collapse">
        <li>
...
<li>
    <a href="#"><i class="glyph-icon flaticon-account"></i><span class="sidebar-text">Account</span><span
            class="fa arrow"></span></a>
    <ul class="submenu collapse">
        <li>
...
<li>
    <a href="#"><i class="glyph-icon flaticon-gallery"></i><span class="sidebar-text">Images Manager</span><span
            class="fa arrow"></span></a>
    <ul class="submenu collapse">
        <li>
...
<li class="m-b-245">
    <a href="charts.html"><i class="glyph-icon flaticon-charts2"></i><span class="sidebar-text">Charts</span><span
            class="pull-right label label-primary">6</span></a>
</li>
</ul>
</div>
<div class="footer-widget">
    ...
    <div class="sidebar-footer clearfix">
        <a class="pull-left" href="profil_edit.html" data-rel="tooltip" data-placement="top"
           data-original-title="Settings"><i class="glyph-icon flaticon-settings21"></i></a>
        ...
        <a class="pull-left" href="lockscreen.html" data-rel="tooltip" data-placement="top"
           data-original-title="Lockscreen"><i class="glyph-icon flaticon-padlock23"></i></a>
        <a class="pull-left" href="login.html" data-rel="tooltip" data-placement="top" data-original-title="Logout"><i
...
<div class="panel-heading bg-red">
    <h3 class="panel-title"><strong>Carriers </strong></h3>
</div>
<div class="panel-body">
    <a role="button" class="add_button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" href="<?php echo base_url() ?>index.php/admin/carrier_cont/add">
...
<li class="img no-arrow have-message">
                <span class="inside-chat">
                    <i class="online"></i>
                    <img src="<?php echo base_url(); ?>admin/img/avatars/avatar3.png" alt="avatar 3"/>
...
<li class="img no-arrow">
                <span class="inside-chat">
                    <i class="online"></i>
                    <img src="<?php echo base_url(); ?>admin/img/avatars/avatar2.png" alt="avatar 2"/>
...
<li class="img no-arrow">
                <span class="inside-chat">
                    <i class="busy"></i>
                    <img src="<?php echo base_url(); ?>admin/img/avatars/avatar13.png" alt="avatar 13"/>
...
<li class="img no-arrow">
                <span class="inside-chat">
                    <i class="away"></i>
                    <img src="<?php echo base_url(); ?>admin/img/avatars/avatar4.png" alt="avatar 4"/>
...
<li class="img no-arrow">
                <span class="inside-chat">
                    <i class="online"></i>
                    <img src="<?php echo base_url(); ?>admin/img/avatars/avatar5.png" alt="avatar 5"/>
...
<li class="img no-arrow">
                <span class="inside-chat">
                    <i class="offline"></i>
                    <img src="<?php echo base_url(); ?>admin/img/avatars/avatar6.png" alt="avatar 6"/>
...
<li class="img no-arrow">
                <span class="inside-chat">
                    <i class="offline"></i>
                    <img src="<?php echo base_url(); ?>admin/img/avatars/avatar7.png" alt="avatar 7"/>
...
<li class="img no-arrow">
                <span class="inside-chat">
                    <i class="offline"></i>
                    <img src="<?php echo base_url(); ?>admin/img/avatars/avatar8.png" alt="avatar 8"/>
...
<li class="img no-arrow">
                <span class="inside-chat">
                        <i class="offline"></i>
                        <img src="<?php echo base_url(); ?>admin/img/avatars/avatar9.png" alt="avatar 9"/>
...
<li class="img no-arrow">
                <span class="inside-chat">
                    <i class="offline"></i>
                    <img src="<?php echo base_url(); ?>admin/img/avatars/avatar12.png" alt="avatar 12"/>
...
<li class="img no-arrow">
                <span class="inside-chat">
                    <i class="offline"></i>
                    <img src="<?php echo base_url(); ?>admin/img/avatars/avatar11.png" alt="avatar 11"/>
...
<li class="img no-arrow">
                <span class="inside-chat">
                    <i class="offline"></i>
                    <img src="<?php echo base_url(); ?>admin/img/avatars/avatar10.png" alt="avatar 10"/>
...
<script src="<?php echo base_url(); ?>admin/plugins/jquery-1.11.js"></script>
<script src="<?php echo base_url(); ?>admin/plugins/jquery-migrate-1.2.1.js"></script>
<script src="<?php echo base_url(); ?>admin/plugins/jquery-ui/jquery-ui-1.10.4.min.js"></script>
<script src="<?php echo base_url(); ?>admin/plugins/jquery-mobile/jquery.mobile-1.4.2.js"></script>
<script src="<?php echo base_url(); ?>admin/plugins/bootstrap/bootstrap.min.js"></script>
<script src="<?php echo base_url(); ?>admin/plugins/bootstrap-dropdown/bootstrap-hover-dropdown.min.js"></script>
<script src="<?php echo base_url(); ?>admin/plugins/bootstrap-select/bootstrap-select.js"></script>
<script src="<?php echo base_url(); ?>admin/plugins/mcustom-scrollbar/jquery.mCustomScrollbar.concat.min.js"></script>
<script src="<?php echo base_url(); ?>admin/plugins/mmenu/js/jquery.mmenu.min.all.js"></script>
<script src="<?php echo base_url(); ?>admin/plugins/nprogress/nprogress.js"></script>
<script src="<?php echo base_url(); ?>admin/plugins/charts-sparkline/sparkline.min.js"></script>
<script src="<?php echo base_url(); ?>admin/plugins/breakpoints/breakpoints.js"></script>
<script src="<?php echo base_url(); ?>admin/plugins/numerator/jquery-numerator.js"></script>
<script src="<?php echo base_url(); ?>admin/plugins/jquery.cookie.min.js" type="text/javascript"></script>
<!-- END MANDATORY SCRIPTS -->
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="<?php echo base_url(); ?>admin/plugins/bootstrap-switch/bootstrap-switch.js"></script>
<script src="<?php echo base_url(); ?>admin/plugins/bootstrap-progressbar/bootstrap-progressbar.js"></script>
<script src="<?php echo base_url(); ?>admin/plugins/datatables/dynamic/jquery.dataTables.min.js"></script>
<script src="<?php echo base_url(); ?>admin/plugins/datatables/dataTables.bootstrap.js"></script>
<script src="<?php echo base_url(); ?>admin/plugins/datatables/dataTables.tableTools.js"></script>
<script src="<?php echo base_url(); ?>admin/plugins/datatables/table.editable.js"></script>
<script src="<?php echo base_url(); ?>admin/js/table_dynamic.js"></script>
<!-- END  PAGE LEVEL SCRIPTS -->
<script src="<?php echo base_url(); ?>admin/js/application.js"></script>
